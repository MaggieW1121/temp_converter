# This version is to add more instructions to the box to make sure the end-user would not feel confused with the function
from tkinter import *
...
class Convertor:
    def __init__(self):
        ...
        self.to_c_button = Button(self.conversion_buttons_frame,
                                  ...
                                  borderless=1,
                                  command=lambda: self.temp_convert(-459)) #minimum value that is valid, which means the minimum is -459
        ...
        self.calc_hist_button = Button(self.hist_help_frame, font="Arial 12 bold",
                                       ...
                                       borderless=1) # wrong width, used to be 15
        self.calc_hist_button.grid(row=0, column=0)

        self.help_button = Button(self.hist_help_frame, font="Arial 12 bold",
                                  text="Help", width=50,
                                  borderless=1) # wrong width, used to be 5
    ...
    def temp_convert(self, to):
        ...
        try:
            ...
            print("oops, you might enter the wrong temperature")
            print("Please enter a number that is greater than -459 degree for fahrenheit and -273 degree for centigrade")
