...
class Convertor:
    def __init__(self):
        ...
        self.temp_instructions_label = Label(self.convertor_frame,
                                             text="Type in the temperature to be"
                                             "converted and then push" # used to be them
    ...
    def temp_convert(self, low):
        ...
        try:
            ...
            # I don't yet have a rounding function so PyCharm might indicate
            # that I have a problem (ie: calling a function which does not exist).
            ...
            elif low == -459 and to_convert >= low: #used to be -458
                celsius = (to_convert - 32) * 5/9
                to_convert = self.round_it(to_convert)
                celsius = self.round_it(celsius)
                answer = "{} °C is {} °F".format(to_convert, celsius)
