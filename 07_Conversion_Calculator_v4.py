# this is to add a error message - configure comment
# this can be achieved through changing the label
# instead of output the conversion, I am going to change it into output the error message

# the problem is the red cannot be removed - to be debugged
from tkinter import *
