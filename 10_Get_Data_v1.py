# This version is based on the code at 07_Conversion_Calculator_v6.py
# because rather than entering a list of test data
# it would better to get the data generated by the program

# I will generate 7 items in this component 
# and use those data in the export GUI component
# time saving (less typing)
    ...
    def temp_convert(self, low):
        ...
        try:
            ...
            # Check and convert to Centigrade
                ...
                answer = "{} °F is {} °C".format(to_convert, celsius) # wrong it used to be {} °C is {} °F
